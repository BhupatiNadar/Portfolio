...
const ProjectPage = () => {
  return (
    <div className="w-full min-h-screen bg-slate-900 flex flex-col items-center py-10">
      ...
      <div className="bg-slate-800 rounded-3xl shadow-2xl p-8 w-96 sm:w-[28rem] text-center transition-transform hover:scale-105">
        ...
        <div className="flex justify-center gap-8 mt-6">
          <a href="https://github.com/BhupatiNadar/Ecommerce">
          ...
          <button className="bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-bold py-3.5 px-10 rounded-2xl text-lg shadow-lg shadow-green-500/30 hover:shadow-green-500/50 transform hover:-translate-y-1 transition-all duration-300">
            Demo
          </button>
        </div>
      </div>
